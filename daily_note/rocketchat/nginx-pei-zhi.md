...
nginx配置：公司部署的聊天室，目前已经完成了长短连接分离。下面是对应的nginx配置。
...
http {
        ...
        server {
                ...
                location /qxglFile {
                        ...
                        proxy_read_timeout 300s;
                        proxy_set_header X-Forwarded-For $proxy_add_x_forwarded_for;
                        proxy_pass http://172.20.20.165:18750/file;
                }
                location /privacy {
                ...
                location /kingduns/business/ {
                        alias /home/jindun/apple-config;
                        try_files $uri $uri/apple-app-site-association =404;
                }
        }
